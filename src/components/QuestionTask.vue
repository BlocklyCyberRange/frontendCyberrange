  ...
  <div class="is-task" :id="taskData.tileNo">
    <div class="is-directive">
      ...
      <div
        ...
        class="is-primary-darker subtitle is-json"
      >
        Completed
      </div>
      ...
      <div v-if="task_completed">
        ...
        <div
          class="buttons is-left mt-5"
          v-if="tlx_completed || completedBefore"
        >
          <!--NEW-->
      ...
      <div v-if="showTask || completedBefore">
        <div
          v-if="!viewJson"
